README: 
The Code is based on this setup: https://www.youtube.com/watch?v=tF-v66PNqBo
/* 
To create audio: https://ttsmaker.com/
DFPlayer module supports up to 3W. 
SD card: 2GB ~ 32GB (perfect 4 GB) formatted with FAT or FAT32. 
MP3 / WAV - audio files. 
*/

#include "SoftwareSerial.h"         // Include the SoftwareSerial library for serial communication https://docs.arduino.cc/learn/built-in-libraries/software-serial/ 
#include "DFRobotDFPlayerMini.h"    // Include the DFRobotDFPlayerMini library for the DFPlayer Mini module https://github.com/DFRobot/DFRobotDFPlayerMini
...
      myDFPlayer.next();            // Play the third audio file on the SD card
